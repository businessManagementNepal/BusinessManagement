...
export const SYNC_BACKEND_AUTH_REQUIRED_MESSAGE =
  "Sync is enabled, but no backend access token is stored for this session. Sign out and sign back in once to connect this local session to the backend before running sync.";
