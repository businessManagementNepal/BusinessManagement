...
export function LedgerEntryEditorModal({
  ...
  return (
    ...
    >
      <DefaultSection
        title="Entry Details"
        subtitle="Required posted fields stay visible by default."
      >
        <ChipSelectorField
          label="Action"
      ...
      <MoreDetailsSection
        title="More Details"
        subtitle="Bill/ref, note, reminder, and attachment."
        collapsed={!state.showMoreDetails}
        onToggleCollapsed={() => viewModel.onToggleMoreDetails()}
        disabled={state.isSaving}
        contentStyle={styles.moreDetailsContent}
      >
        <LabeledTextInput
