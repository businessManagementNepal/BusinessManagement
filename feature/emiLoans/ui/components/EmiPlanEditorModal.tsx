...
export function EmiPlanEditorModal({
  ...
  const shouldExpandMoreDetails =
    state.counterpartyName.trim().length > 0 ||
    state.counterpartyPhone.trim().length > 0 ||
    state.reminderEnabled ||
    state.note.trim().length > 0 ||
    Boolean(state.fieldErrors.reminderDaysBefore);
  ...
  return (
    ...
    >
      <DefaultSection
        title="Plan Details"
        subtitle="Required repayment fields stay visible by default."
      >
        <ChipSelectorField
          label="Plan Type"
      ...
      <MoreDetailsSection
        title="More Details"
        subtitle="Optional counterparty, reminder, and note settings."
          ...
          <View style={styles.switchRow}>
            <View style={styles.switchTextWrap}>
              ...
              <Text style={styles.switchSubtitle}>
                Save reminder preference with this plan
              </Text>
            </View>
            <Switch
